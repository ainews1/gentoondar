...
abstract class TaskRepository {
  ...
  Future<dartz.Either<Failure, List<Task>>> searchTasks(String searchTerm);
  ...
  Future<dartz.Either<Failure, List<Task>>> getTasksInDateRange(DateTime? startDate, DateTime? endDate);

  /// Get tasks filtered by completion status.
  /// Returns Either<Failure, List<Task>> with tasks matching the completion status.
  Future<dartz.Either<Failure, List<Task>>> getTasksByCompletionStatus(bool isCompleted);
}